...
-- 外部化されたSQLクエリファイル
-- 元ファイル: ArmTemplate_4.json (MovingPromotionList pipeline)
-- 出力列数: 4列 (GASMETER_INSTALLATION_LOCATION_NUMBER_1X, USAGE_CONTRACT_NUMBER_4X, MOVING_FORECAST_WITHIN_TWO_MONTHS, OUTPUT_DATETIME)
-- 重複削除条件: DISTINCT（重複自動除去）
-- 外部化日: 2024-01-16
---------------------------------------------------------
