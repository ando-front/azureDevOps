...
-- 外部化されたSQLクエリファイル
-- 元ファイル: ArmTemplate_4.json (PaymentMethodMaster pipeline)
-- 出力列数: 7列 (Bx, INDEX_ID, SIH_KIY_NO, SHIK_SIH_KIY_JTKB, SIH_HUHU_SHBT, SIK_SVC_SHBT, OUTPUT_DATETIME)
-- 重複削除条件: Bx+SIH_KIY_NO単位でOUTPUT_DATE降順
-- 外部化日: 2024-01-16
----------------------------------------------------------------------------
